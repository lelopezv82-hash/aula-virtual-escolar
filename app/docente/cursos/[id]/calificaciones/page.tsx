...
export default function CalificacionesConsolidadoPage() {
  ...
  const exportToExcel = () => {
    ...
    const worksheetData = sortedStudents.map(student => {
      ...
      return {
        ...
        "Ser (Aptitudinal)": pg.ser !== null ? pg.ser : "—",
  ...
  const exportToPDF = () => {
    ...
    const tableColumn = ["Estudiante", "Grupo", "Saber (Examenes)", "Hacer (Tareas)", "Ser (Aptitudinal)", "Nota Final"];
                  ...
                  <thead>
                    <tr style={{ background: "var(--bg-secondary)", borderBottom: "2px solid var(--border-color)" }}>
                      ...
                      >
                        ...
                        <div style={{ fontSize: "0.65rem", fontWeight: 500, color: "var(--text-muted)", marginTop: "0.1rem" }}>Aptitudinal</div>
                      </th>
