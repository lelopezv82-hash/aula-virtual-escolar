...
export default async function CursoDescripcionPage({
  ...
  const taskItems: MoodleItem[] = tasks.map(t => {
    ...
    return {
      ...
      submissionAllowLateSubmission: submission?.allowLateSubmission,
      submissionLateSubmissionUntil: submission?.lateSubmissionUntil ? submission.lateSubmissionUntil.toISOString() : null,
