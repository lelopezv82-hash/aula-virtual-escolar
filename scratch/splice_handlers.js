...
const beforeLines = lines.slice(0, 1094); // 0-indexed up to line 1094 (exclusive)
const afterLines = lines.slice(1116); // from line 1117 (const toggleSelectAllFiltered)

const newMiddle = `  const handleCloneFromPicker = async () => {
...
const finalContent = beforeLines.join('\n') + '\n' + newMiddle + '\n' + afterLines.join('\n');
fs.writeFileSync('app/docente/planillas/PlanillasClient.tsx', finalContent, 'utf8');
console.log('Successfully spliced and written PlanillasClient.tsx');
